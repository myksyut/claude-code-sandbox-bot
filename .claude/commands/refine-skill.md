...
```
1. どのスキルを変更しますか？
   例: python-rules / coding-standards / documentation-criteria
...
【ユーザー要求】
「Pythonのエラーハンドリング基準を厳格化したい」

【変更内容】
対象: .claude/skills/python-rules/SKILL.md
セクション: ## エラーハンドリング
