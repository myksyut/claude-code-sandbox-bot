...
skills: documentation-criteria, technical-spec, project-context, python-rules
---
...
7. **実装サンプル規約準拠**: すべての実装例がpython-rulesスキル基準に完全準拠することを検証
...
2. **実装整合性**: コード例のpython-rulesスキル完全準拠、interface定義の一致
