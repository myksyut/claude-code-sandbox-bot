...
skills: documentation-criteria, frontend/technical-spec, frontend/python-rules, coding-standards, project-context, implementation-approach
---
...
- frontend/python-rulesスキルでフロントエンドPython開発ルールを適用
...
直接影響:
  - src/components/UserProfileCard/UserProfileCard.py (Props変更)
  - src/pages/ProfilePage.py (使用箇所)
間接影響:
...
**必須**: ADRとDesign Doc内の全実装サンプルは、例外なくfrontend/python-rulesスキル基準に厳格準拠すること。
