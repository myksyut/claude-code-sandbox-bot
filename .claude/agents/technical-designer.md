...
skills: documentation-criteria, technical-spec, python-rules, coding-standards, project-context, implementation-approach
---
...
**必須**: ADR・Design Doc内のすべての実装サンプルはpython.mdの規約に完全準拠すること。
